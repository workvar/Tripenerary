...
export default function ScreenHeader({ title, onClose, actionLabel = 'Done' }: ScreenHeaderProps) {
  return (
    <View style={s.header}>
      <Text style={s.title}>{title}</Text>
      <Press onPress={onClose} style={s.action} scaleTo={0.94} accessibilityLabel={actionLabel}>
