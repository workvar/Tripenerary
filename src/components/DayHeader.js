...
export default function DayHeader({ day, totalDays, todayDate, showImages }) {
  ...
  const base = day.base ? day.base.toUpperCase() : '';
      ...
      {hero ? (
        <SmartImage uri={hero} style={s.hero} radiusValue={radius.lg}>
          ...
          <View style={s.heroText}>
            ...
            {day.title ? <Text style={s.heroTitle} numberOfLines={2}>{day.title}</Text> : null}
          </View>
        </SmartImage>
      ) : null}
