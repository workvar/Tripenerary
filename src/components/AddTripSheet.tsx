...
interface AddTripSheetProps {
  ...
  readonly onSubmit: (url: string) => Promise<Result<string>>;
}

/** Bottom sheet for pasting a new itinerary link. Slides up over a dimmed backdrop. */
export default function AddTripSheet({ visible, onClose, onSubmit }: AddTripSheetProps) {
    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      ...
      >
        <Animated.View style={[s.sheet, { transform: [{ translateY }] }]}>
          ...
          <Text style={s.help}>
            Paste the link to an itinerary JSON file. GitHub, Gist, Google Drive and Dropbox share
